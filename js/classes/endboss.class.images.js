export let imagesBossIntroduce = [
...
export let imagesBossSwim = [
  ...
  "../../assets/img/2.Enemy/3 Final Enemy/1.Introduce/9.png",
  "../../assets/img/2.Enemy/3 Final Enemy/1.Introduce/10.png",
  "../../assets/img/2.Enemy/3 Final Enemy/1.Introduce/11.png",
  "../../assets/img/2.Enemy/3 Final Enemy/1.Introduce/12.png",
  "../../assets/img/2.Enemy/3 Final Enemy/1.Introduce/13.png",
];

export let imagesBossAttack = [
